 ...
 * Все UI-зависимости (SceneManager, DialogDisplayer) не создаются. Для работы
 * с файлами клиент должен самостоятельно реализовать сохранение зашифрованных данных.
 * </p>
 *
 * @author dankotyt
 * @since 1.1.1
