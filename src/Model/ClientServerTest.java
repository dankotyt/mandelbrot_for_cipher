...
public class ClientServerTest {
    ...
    private static List<String> readImagePathsFromFile() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            System.out.println("Пути к изображениям успешно прочитаны из файла: " + file.getAbsolutePath());
    ...
    public static void main(String[] args) {
        ...
        Thread clientAThread = new Thread(() -> {
            try {
                ...
                if (imagePath == null) {
                    System.err.println("Ошибка: путь к изображению не найден.");
                    clientA.disconnect();
                    return;
                }
                ...
                if (!fileToSend.exists()) {
                    System.err.println("Ошибка: файл не существует: " + imagePath);
                    clientA.disconnect();
                    return;
                }
                ...
                synchronized (System.out) {
                    System.out.println("Client A: File sent"); // Changed from "File received" to "File sent"
                }
        ...
        Thread clientBThread = new Thread(() -> {
            try {
                ...
                synchronized (System.out) {
                    System.out.println("Client B: File received: " + fileName);
                }
